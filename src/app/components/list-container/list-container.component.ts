...
export class ListContainerComponent implements OnInit, OnDestroy {
    ...
    this.calendarService.activitiesSubject
      ...
      .subscribe(activities => {
        this.activities = this.calendarService.filterActivitiesByDate(
          ...
          this.calendarService.sortActivitiesByDate(activities)
        )
      })
  }
  ...
  onDeleteActivity(activityId: number) {
    this.calendarService.activitiesSubject.next(this.calendarService.activitiesSubject.value.filter(act =>
